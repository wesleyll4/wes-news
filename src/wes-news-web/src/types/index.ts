...
export const CategoryLabels: Record<Category, string> = {
  ...
  [Category.GitHubTrends]: 'GitHub Trends',
}
...
export const CategoryColors: Record<Category, { bg: string; text: string; dot: string }> = {
  ...
  [Category.GitHubTrends]: { bg: 'bg-orange-100 dark:bg-orange-950/60',  text: 'text-orange-700 dark:text-orange-400',  dot: 'bg-orange-500' },
}
